...
const STRINGS = {
  en: {
    ...
    openRuqyah: 'For protection & healing, try the Ruqyah app',
    ...
    replayAudio: 'Replay Athkar',
    previousAudio: 'Previous item',
    nextAudio: 'Next item',
    closeAudio: 'Close audio player',
    audioPlayer: 'Athkar audio player',
    ...
    speedSlider: 'Playback speed slider',
  ...
  ar: {
    ...
    openRuqyah: 'للتحصين والاستشفاء، جرّب تطبيق الرقية',
    ...
    speedPresets: 'خيارات السرعة',
    speedSlider: 'شريط ضبط السرعة',
    audioReciter: 'مشاري العفاسي',
    audioError: 'تعذّر تحميل هذا الصوت. حاول مرة أخرى أو اختر ذكرًا آخر.',
